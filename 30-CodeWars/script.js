...
//==========================================================================================
function rentalCarCost(d) {     //Dit is wel een heel mooi voorbeeld
    return d * 40 - (d >= 7 ? 50 : (d >= 3 ? 20 : 0));
};

function rentalCarCost2(d) {     //Zo heb ik hem gedaan...
    if (d < 3) return d * 40;
...
for (let i = 0; i <= 10; i++) {
    console.log(`The cost for ${i} day(s) of car rental is ${rentalCarCost(i)} euro`);
    console.log(`The cost for ${i} day(s) of car rental is ${rentalCarCost2(i)} euro`);
};
